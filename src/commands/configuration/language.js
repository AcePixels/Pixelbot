...
module.exports = class ConfigLanguage extends Command {
    ...
    super({
      ...
      parameters: [{
        ...
        missingError: ({ t, prefix, author }) => {
          return new SlayBotEmbed().setTitle(t('commands:language.noCode'))
            .setDescription([
              this.usage(t, prefix),
              '',
              `__**${t('commands:language.availableLanguages')}:**__`,
  ...
  async run ({ t, author, channel, guild }, lang) {
    ...
    try {
      ...
      embed.setTitle(i18next.getFixedT(lang)('commands:language.changedSuccessfully', { lang: langDisplayName || lang }))
    } catch (e) {
